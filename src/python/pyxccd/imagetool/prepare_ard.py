...
@click.option("--low_date_bound", type=str, default=None, help="the lower bound of the date range of user interest" "Example - 2019-01-01")
@click.option("--upp_date_bound", type=str, default=None, help="the upper bound of the date range of user interest" "Example - 2024-12-31")
